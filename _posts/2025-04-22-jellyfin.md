...
12. **Finish Installation**: Let the install process complete. When prompted, select **"Reboot Now"** and remove the USB drive. If you don't remove the USB drive because 
